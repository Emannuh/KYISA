...
def sys_admin_dashboard_view(request):
    ...
    role_workspaces = [
        ...
        },
        {
            ...
            'description': 'Finance control for county payments, registration approvals, and treasury workflows.',
            'functions': [
                {'label': 'Treasurer Dashboard', 'summary': 'Open finance overview and treasury workload.', 'icon': 'bi bi-speedometer2', 'url': 'treasurer_dashboard'},
                {'label': 'County Payments', 'summary': 'Review and confirm county payments.', 'icon': 'bi bi-credit-card-2-front', 'url': 'treasurer_county_payments'},
                {'label': 'County Registrations', 'summary': 'Approve or reject county registration requests.', 'icon': 'bi bi-building-check', 'url': 'treasurer_county_registrations'},
                {'label': 'Statistics', 'summary': 'View finance-related and system-wide metrics.', 'icon': 'bi bi-graph-up-arrow', 'url': 'statistics_dashboard'},
            ],
        },
        {
            'title': 'Secretary General',
            ...
            'description': 'Executive oversight across verifications, appeals, treasurer actions, and exceptions.',
            'functions': [
                {'label': 'SG Dashboard', 'summary': 'Open executive dashboard for strategic oversight.', 'icon': 'bi bi-speedometer2', 'url': 'sg_dashboard'},
                {'label': 'Verifications', 'summary': 'Review verification decisions and escalations.', 'icon': 'bi bi-patch-check', 'url': 'sg_verifications'},
                {'label': 'Appeals', 'summary': 'Inspect appeals pipeline and outcomes.', 'icon': 'bi bi-briefcase', 'url': 'sg_appeals'},
                {'label': 'User Actions', 'summary': 'Monitor sensitive user-level activities.', 'icon': 'bi bi-journal-richtext', 'url': 'sg_user_actions'},
            ],
        },
        {
            ...
            'description': 'County and player verification workflows for eligibility and compliance checks.',
            'functions': [
                {'label': 'Registered Counties', 'summary': 'Review approved counties entering verification.', 'icon': 'bi bi-building', 'url': 'vo_registered_counties'},
                {'label': 'CM Verification', 'summary': 'Cross-check county players and verification statuses.', 'icon': 'bi bi-person-vcard', 'url': 'county_player_verification_list'},
            ],
        },
        {
            'title': 'Jury Chair',
            ...
            'description': 'Appeals and disciplinary review operations with report access.',
            'functions': [
                {'label': 'Jury Dashboard', 'summary': 'Open jury control panel for hearing workflows.', 'icon': 'bi bi-speedometer2', 'url': 'jury_dashboard'},
                {'label': 'Teams Data', 'summary': 'Inspect team data and eligibility records.', 'icon': 'bi bi-people', 'url': 'jury_teams'},
                {'label': 'Players Data', 'summary': 'Inspect player data and verification outcomes.', 'icon': 'bi bi-person-lines-fill', 'url': 'jury_players'},
                {'label': 'Disciplinary', 'summary': 'Review disciplinary events and sanctions context.', 'icon': 'bi bi-exclamation-octagon', 'url': 'jury_disciplinary'},
            ],
        },
        {
            'title': 'Scouts',
            ...
            'description': 'Scouting operations for browsing verified players and maintaining shortlists.',
            'functions': [
                {'label': 'Scout Dashboard', 'summary': 'Open scouting hub and activity overview.', 'icon': 'bi bi-speedometer2', 'url': 'scout_dashboard'},
                {'label': 'Player Discovery', 'summary': 'Browse and filter players for scouting decisions.', 'icon': 'bi bi-search', 'url': 'scout_players'},
                {'label': 'Shortlist', 'summary': 'Manage shortlisted prospects and notes.', 'icon': 'bi bi-star', 'url': 'scout_shortlist'},
            ],
        },
        {
            'title': 'CEC Sports',
            ...
            'count_label': 'cec users',
            'description': 'Read-only county and competition oversight for executive leadership.',
            'functions': [
                {'label': 'CEC Dashboard', 'summary': 'Open executive visibility dashboard.', 'icon': 'bi bi-speedometer2', 'url': 'cec_sports_portal'},
            ],
        },
    ]
